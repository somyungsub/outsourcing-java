...
public class BankApplication2 {
    ...
    private static int acoountIdx = 0;
    ...
    private static void createAccount() {
        ...
        accountList[acoountIdx++] = new Account(ano, owner, balance);
    }
    ...
    private static void listAccounts() {
        ...
        for (int i = 0; i < acoountIdx; i++) {
            System.out.println(accountList[i].getAno() + "\t" + accountList[i].getOwner() + "\t" + accountList[i].getBalance());
        }
    }
